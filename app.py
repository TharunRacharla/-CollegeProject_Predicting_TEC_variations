...
def predict():
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.33, random_state=1) # 3 parts go to testing and 7 parts go to training for every 10 parts
    ...
    output = prediction[inputval]
    
    return render_template('index.html', prediction_text='the value of TEC content is {}'.format(output))
